"""Deterministic arithmetic pricing functions."""

from __future__ import annotations

from typing import Any

from app.estimator.schemas import QuantityEstimate
...
def estimate_quantity(
    ...
    web_width_in = normalized_input["actual_web_width_in"]
    ...
    material_cost_total = (
        ((run_length_ft * web_width_in) / 1000)
    ...
    return QuantityEstimate(
        ...
        cost_per_label=round(total_cost / quantity, 6),
        sell_price_total=round(sell_price_total, 6),
        sell_price_per_label=round(sell_price_total / quantity, 6),
        gross_profit=round(gross_profit, 6),
        gross_margin_pct=round((gross_profit / sell_price_total) * 100, 6),
    )
